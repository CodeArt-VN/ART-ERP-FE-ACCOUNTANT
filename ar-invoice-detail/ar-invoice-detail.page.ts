...
export class ARInvoiceDetailPage extends PageBase {
    ...
    lockItemsStatus = ['EInvoiceRelease', 'EInvoiceCancel', 'ARInvoiceApproved', 'ARInvoicePending', 'ARInvoiceCanceled', 'ARInvoiceSplited', 'ARInvoiceMerged'];
    lockHeaderStatus = ['EInvoiceRelease', 'EInvoiceNew', 'EInvoiceCancel', 'EInvoiceEmpty', 'ARInvoiceApproved', 'ARInvoicePending', 'ARInvoiceCanceled', 'ARInvoiceSplited', 'ARInvoiceMerged'];
    ...
    constructor(
        ...
        this.formGroup = formBuilder.group({
            ...
            TypeCreateInvoice: new FormControl({ value: 'ItemList', disabled: false }),
        ...
        initSearch() {
            ...
            this.items$ = concat(
                ...
                this.input$.pipe(
                    ...
                    switchMap(term => this.searchProvider.search({ SortBy: ['Id_desc'], Take: 20, Skip: 0, SkipMCP: true, SkipAddress: true, Term: term }).pipe(
    ...
    preLoadData(event?: any): void {
        ...
        this.pageProvider.commonService.connect('GET', 'SYS/Config/ConfigByBranch', { Code: 'TaxOutput', IDBranch: this.env.selectedBranch }).toPromise().then(resp => {
    ...
    removeContent(g, index) {
        this.env.showPrompt('Are you sure you want to delete this row(s)?').then(_ => {
            let groups = <FormArray>this.formGroup.controls.Contents;
