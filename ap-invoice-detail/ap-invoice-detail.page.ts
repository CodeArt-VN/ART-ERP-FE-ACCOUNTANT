...
import { AC_APInvoiceProvider, BRA_BranchProvider, PURCHASE_OrderProvider, WMS_ReceiptProvider } from 'src/app/services/static/services.service';
...
export class APInvoiceDetailPage extends PageBase {
    ...
    constructor(
        ...
        this.formGroup = formBuilder.group({
            ...
            TotalDiscount: [0],
            CalcTotalAfterDiscount: new FormControl({ value: 0, disabled: true }),
            Tax: [0],
            WithholdingTax: [0],
